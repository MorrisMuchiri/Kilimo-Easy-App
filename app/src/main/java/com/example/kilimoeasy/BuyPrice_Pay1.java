...
public class BuyPrice_Pay1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_price__pay1);

        listViewProduce = findViewById(R.id.listViewProduce1_pay1);
        ...
        listViewProduce.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), Farmer_Payment1.class);
    ...
    protected void onStart() {
        ...
        databaseProduce.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ProduceList1_pay adapter = new ProduceList1_pay(BuyPrice_Pay1.this, produceList1_pay);
