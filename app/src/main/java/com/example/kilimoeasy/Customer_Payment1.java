...
public class Customer_Payment1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer__payment1);
        ...
        listviewcustomerpayment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), CustomerMoney1.class);
    ...
    protected void onStart() {
        ...
        databaseCustomerOrders.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                CustomerOrderList adapter = new CustomerOrderList(Customer_Payment1.this, corderList);
