...
public class Vendor_Payment0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor__payment0);
        ...
        listviewvendorpayment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), VendorMoney1.class);
    ...
    protected void onStart() {
        ...
        databaseVendorPayment.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                VendorOrderList adapter = new VendorOrderList(Vendor_Payment0.this, vorderList);
