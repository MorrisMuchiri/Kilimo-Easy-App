...
public class Farmer_Payment1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer__payment1);
        ...
        listviewfarmerpayment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), FarmerMoney1.class);
    ...
    protected void onStart() {
        ...
        databaseFarmerOrders.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FarmerOrderList adapter = new FarmerOrderList(Farmer_Payment1.this, forderList);
