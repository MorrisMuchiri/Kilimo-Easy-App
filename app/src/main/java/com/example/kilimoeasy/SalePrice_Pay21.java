...
public class SalePrice_Pay21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_price__pay21);
        listViewProduce = findViewById(R.id.listViewProducePay21);
        ...
        listViewProduce.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), Customer_Payment21.class);
    ...
    protected void onStart() {
        ...
        databaseProduce.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ProduceList2_Pay adapter = new ProduceList2_Pay(SalePrice_Pay21.this, produceList2);
