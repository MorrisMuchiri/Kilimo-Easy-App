...
public class SalePrice_Pay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_price__pay);

        listViewProduce = findViewById(R.id.listViewProducePay);
    ...
    protected void onStart() {
        ...
        databaseProduce.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ProduceList2_Pay adapter = new ProduceList2_Pay(SalePrice_Pay.this, produceList2);
