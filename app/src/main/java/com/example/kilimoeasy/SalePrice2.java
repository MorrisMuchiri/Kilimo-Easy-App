...
public class SalePrice2 extends AppCompatActivity {

    public static final String PRODUCE_NAME = "producename";
    public static final String PRODUCE_ID = "produceid";
    public static final String PRODUCE_SALEPRICE = "producesaleprice";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_price2);

        listViewProduce = findViewById(R.id.listViewProduce3);
        ...
        listViewProduce.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), VendorOrder.class);

                intent.putExtra(PRODUCE_ID, produce.getType_id());
                intent.putExtra(PRODUCE_NAME, produce.getPname());
                intent.putExtra(PRODUCE_SALEPRICE, produce.getSale_price());
    ...
    protected void onStart() {
        ...
        databaseProduce.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ProduceList2 adapter = new ProduceList2(SalePrice2.this, produceList2);
